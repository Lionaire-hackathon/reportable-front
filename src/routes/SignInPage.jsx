...
const SignInPage = () => {
    ...
    return (
        ...
        >
            ...
            >
                <div className="flex flex-col gap-[23px] items-center justify-start shrink-0 w-[423px] relative">
                    <div className="flex flex-col gap-[35px] items-start justify-start self-stretch shrink-0 relative">
                        ...
                        <div className="flex flex-col gap-[22px] items-start justify-start self-stretch shrink-0 relative">
                            <div className="shrink-0 w-[260px] h-[72px] static">
                            ...
                            <div className="shrink-0 w-full h-auto static flex flex-col gap-2 pb-4">
                                ...
                                <button className="bg-[#000000] rounded-md !h-[57px] relative w-full my-1">
                                    <div className="text-[#ffffff] text-left font-['Poppins-Medium',_sans-serif] text-base font-medium absolute left-[190px] top-[17px]">
                                        Login{" "}
                                    </div>
                                </button>
                                ...
                                <button className="bg-[#ffffff] rounded-[9px] border-solid border-[#689df6] border p-[0.75rem] my-1 flex gap-2.5 items-center item-center justify-center relative">
                                    <div className="flex flex-row gap-3 items-center justify-center shrink-0 relative">
                                        ...
                                        <div className="text-[#b5b5b5] text-left font-['Poppins-Regular',_sans-serif] text-base font-normal relative w-[161.89px] h-[20.07px]" onClick={handleGoogleLogin}>
                                            Sign in with Google{" "}
                                        </div>
                                    </div>
                                </button>

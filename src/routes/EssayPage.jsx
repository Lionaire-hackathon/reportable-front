      ...
      <div className="flex flex-row items-center justify-between relative w-[100%]">
        ...
        >
          <div className="flex flex-col gap-[250px] items-start justify-start shrink-0 w-[289px] relative">
            ...
            <button
              className="bg-[#005f5f] rounded-[10px] pt-2 pr-4 pb-2 pl-4 flex flex-row gap-1 items-center justify-center self-stretch shrink-0 h-[60px] relative"
              style={{
        ...
        <div className="bg-[#d9d9d9] pt-[33px] pr-[235px] pb-[33px] pl-[235px] flex flex-row flex-grow gap-2.5 items-center justify-center shrink-0 h-[950px] relative">

...
const HomePage = () => {
  return (
    <div className="flex flex-col gap-0 items-center justify-start w-full absolute left-0 top-[104px]">
      <div className="bg-white flex flex-col gap-[45px] items-center justify-start w-full h-[551px] relative">
        <div className="flex flex-col gap-0 items-center justify-start w-full h-[339px] relative">
          <div className="bg-[#299792] w-full h-[339px] relative"></div>
          <div className="flex flex-row gap-[71px] items-center justify-center w-full max-w-[1024px] mx-auto absolute left-0 right-0 top-11">
            <div className="flex flex-col gap-[27px] items-start justify-start w-[315px] relative">
              <div className="text-left font-['Inter-Bold',_sans-serif] text-3xl font-bold relative self-stretch">
                <span>
                  ...
                  <span className="div-span2">- 레포터블</span>
                </span>{" "}
              </div>
              <div className="flex flex-row gap-0 items-center justify-center shrink-0 h-[77px] relative">
                ...
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <path d="M7 2L17 12L7 22" stroke="black" strokeWidth="2" />
                </svg>
        ...
        <div className="flex flex-col gap-2.5 items-center justify-start w-full absolute left-0 right-0 top-[412px]">
          <div className="flex flex-row items-center justify-center gap-2.5 w-full relative">
      ...
      <div className="bg-[#cae5e4] flex flex-col gap-0 items-center justify-center w-full h-[825px] relative">
        <div className="text-[#000000] text-left font-['Inter-Bold',_sans-serif] text-[25px] font-bold absolute left-14 top-7">
          FAQ.
          <br />
          레포터블, 어떻게 사용하나요?{" "}
        </div>
        <div className="flex flex-col gap-6 items-start justify-start w-full max-w-[1322.5px] mx-auto absolute left-0 right-0 top-[124px]">
          <Toggle

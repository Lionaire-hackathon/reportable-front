...
const MyPage = () => {
    ...
    return (
        <div className="bg-[#ffffff] h-[4524px] relative overflow-auto">
            ...
            <div className="flex flex-col gap-[84px] items-start justify-start w-[1052px] h-[4403px] absolute left-[339px] top-40">
                <div className="flex flex-col gap-[39px] items-start justify-start self-stretch shrink-0 relative">
                    <div className="flex flex-col gap-[11px] items-start justify-start shrink-0 w-[1052px] relative">
                        ...
                        <div className="text-[#656565] text-left font-['Inter-Medium',_sans-serif] text-xl leading-[160%] font-medium relative self-stretch flex items-center justify-start">
                            Reportable은 LLM(Anthropic API)을 이용하여 사용자가
                            요구하는 조건에 맞는 학술보고서를 작성해주는 서비스
                            플랫폼입니다. Reportable은 반복되는 문서작업에
                            피로감을 느끼는 대학생들과 직장인들에게 효율적이고
                            정확한 보고서 작성 도구를 제공합니다. 사용자는
                            간단한 입력을 통해 원하는 주제, 분량, 형식 등을
                            설정할 수 있으며, 인공지능이 이를 바탕으로 고품질의
                            맞춤형 보고서를 생성합니다.
                        </div>
                    </div>
                    <div className="bg-[#ffffff] rounded-[10px] border-solid border-[#d9d9d9] border pt-2.5 pr-[30px] pb-2.5 pl-[30px] flex flex-row gap-10 items-center justify-start shrink-0 w-[1052px] h-[704px] relative">
                        <img
                            className="shrink-0 w-[546px] h-[470px] relative"
                            style={{ objectFit: "cover" }}
                            src={differentiators}
                        />
                        <div className="flex flex-col gap-[31px] items-start justify-start shrink-0 w-[382px] relative">
                            <div
                            ...
                            <div className="flex flex-col gap-2.5 items-start justify-start shrink-0 w-[382px] relative">
                                <div
                ...
                <div className="flex flex-col gap-[60px] items-start justify-start self-stretch shrink-0 h-[3109px] relative">
                    <div className="flex flex-col gap-[11px] items-start justify-start shrink-0 w-[1052px] relative">
                        <div className="text-[#656565] text-left font-['Inter-Medium',_sans-serif] text-xl leading-[160%] font-medium relative self-stretch flex items-center justify-start">
                            사용방법{" "}
                        </div>
                        ...
                        <div className="text-[#656565] text-left font-['Inter-Medium',_sans-serif] text-xl leading-[160%] font-medium relative self-stretch flex items-center justify-start">
                            ...
                            essay는 개인의 주관적인 생각과 논지를 중심으로 특정
                            주제에 대해 논리적으로 서술하는 것에 초점이 맞춰져
                            있습니다. 연구보고서는 좀 더 체계적이고 형식적인
                            양식 하에서 특정 주제에 대한 연구 결과를 객관적으로
                            보고하는 형태로, 사용자가 제공한 연구 결과를
                            바탕으로 명확한 답변을 제공하는 것에 초점이 맞춰져
                            있습니다.{" "}
                        </div>
                    </div>
                    <div className="flex flex-col gap-5 items-start justify-start shrink-0 w-[1052px] relative">
                        ...
                        <div className="text-[#656565] text-left font-['Inter-Medium',_sans-serif] text-xl leading-[160%] font-medium relative self-stretch flex items-center justify-start">
                            Reportable의 홈페이지에서 essay 작성페이지로 접근할
                            수 있습니다.{" "}
                        </div>
                    </div>
                    <div className="bg-[#ffffff] rounded-[10px] border-solid border-[#d9d9d9] border pt-[50px] pr-[30px] pb-[50px] pl-[30px] flex flex-col gap-10 items-start justify-start shrink-0 w-[1052px] h-[1448px] relative">
                        <div className="flex flex-row items-center justify-between shrink-0 w-[992px] relative">
                            <img
                                className="shrink-0 w-[357px] h-[445px] relative"
                                style={{ objectFit: "cover" }}
                                src={essayInfo1}
                            />
                            <div className="flex flex-col gap-2.5 items-center justify-center shrink-0 w-[595px] h-[445px] relative">
                                <div
                        ...
                        <div className="flex flex-row items-center justify-between shrink-0 w-[992px] relative">
                            <div className="flex flex-col gap-2.5 items-center justify-center shrink-0 w-[509px] h-[445px] relative">
                                <div
                                    className="text-[#121212] text-left pl-4 text-[20px] font-bold relative self-stretch h-[29px] flex items-center justify-start"
                                    style={{
                                        letterSpacing:
                            ...
                            <img
                                className="shrink-0 w-[434.7px] h-[445px] relative"
                                style={{ objectFit: "cover" }}
                                src={essayInfo2}
                            />
                        </div>
                        <div className="flex flex-row items-center justify-between shrink-0 w-[992px] relative">
                            <img
                                className="shrink-0 w-[433px] h-[445px] relative"
                                style={{ objectFit: "cover" }}
                                src={essayInfo3}
                            />
                            <div className="flex flex-col gap-2.5 items-center justify-center shrink-0 w-[479px] h-[445px] relative">
                                <div
                                    className="text-[#121212] text-left pl-4 text-[20px] font-bold relative self-stretch h-[29px] flex items-center justify-start"
                                    style={{
                                        letterSpacing:
                                ...
                                <div className="bg-[#FAFAFA] ounded-2xl pt-5 pr-[30px] pb-5 pl-[30px] flex flex-row gap-3 items-center justify-start self-stretch shrink-0 relative">
                                    <div className="flex flex-row gap-3 items-center justify-start flex-1 relative">
                                        <div
                                            ...
                                            style={{ letterSpacing: "0.2px" }}
                                        >
                                            1~2분 정도로 기다리면 오른쪽의 문서
                                            부분에서 완성된 보고서의 docx 파일을
                                            확인할 수 있습니다. 또한 우측 상단의
                                            저장 아이콘을 클릭하면 해당 문서를
                                            다운로드 받을 수 있습니다. <br />
                                            <br />
                                            추가로 한 번 생성된 보고서의 경우
                                            이후에도 My Page에서 확인할 수
                                            있습니다.{" "}
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="bg-[#ffffff] rounded-[10px] border-solid border-[#d9d9d9] border pt-[50px] pr-[30px] pb-[50px] pl-[30px] flex flex-col gap-10 items-start justify-start shrink-0 w-[1052px] h-[977px] relative">
                        <div className="flex flex-row items-center justify-between shrink-0 w-[992px] relative">
                            <img
                                className="shrink-0 w-[397px] h-[445px] relative"
                                style={{ objectFit: "cover" }}
                                src={researchInfo1}
                            />
                            <div className="flex flex-col gap-2.5 items-center justify-center shrink-0 w-[595px] h-[445px] relative">
                        ...
                        <div className="flex flex-row items-center justify-between shrink-0 w-[992px] relative">
                            ...
                            <img
                                className="shrink-0 w-[433px] h-[438.92px] relative"
                                style={{ objectFit: "cover" }}
                                src={researchInfo2}
                            />
                        </div>
